...
# and). So R8 style. So we keep R8 explicitly from optimizing it
...
# kept., Kotlin Flows, and Callable return types are not kept. Warn if this occurs.
...
# ==================== Tink ====================
# Keep Tink's internal classes and proto messages
...
# ==================== Hilt ====================
# Hilt generates code that ProGuard needs to keep
