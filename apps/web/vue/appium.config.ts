...
const iosCapabilities = {
  ...
  "appium:app":
    process.env.IOS_APP_PATH || "./platforms/ios/build/Debug-iphonesimulator/happyvue.app",
...
const androidCapabilities = {
  ...
  "appium:app":
    process.env.ANDROID_APP_PATH || "./platforms/android/app/build/outputs/apk/debug/app-debug.apk",
