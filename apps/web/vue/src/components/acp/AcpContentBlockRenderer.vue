...
<template>
  ...
  <div v-else-if="props.content.type === 'image'" class="my-1 overflow-hidden rounded-lg">
    <img
  ...
  >
    ...
    <p
      v-if="'text' in props.content.resource"
      class="mt-1 text-sm text-foreground whitespace-pre-wrap"
    >
