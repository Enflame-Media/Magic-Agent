        ...
        <CardContent class="space-y-4">
          ...
          <div class="flex items-center justify-between rounded-lg border p-4">
            ...
            <button
              ...
              :class="
                notifications.messages && notificationsEnabled ? 'bg-green-500' : 'bg-gray-400'
              "
            ...
            >
              <span
                class="pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out"
                :class="
                  notifications.messages && notificationsEnabled ? 'translate-x-5' : 'translate-x-0'
                "
              />
            </button>
          </div>
          ...
          <div class="flex items-center justify-between rounded-lg border p-4">
            ...
            <button
              ...
              class="relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
              :class="
                notifications.sessionActivity && notificationsEnabled
                  ? 'bg-green-500'
                  : 'bg-gray-400'
              "
          ...
          <div class="flex items-center justify-between rounded-lg border p-4">
            ...
            <button
              ...
              class="relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
              :class="
                notifications.machineStatus && notificationsEnabled ? 'bg-green-500' : 'bg-gray-400'
              "
            ...
            >
              <span
                class="pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out"
                :class="
                  notifications.machineStatus && notificationsEnabled
                    ? 'translate-x-5'
                    : 'translate-x-0'
                "
              />
          ...
          <div class="flex items-center justify-between rounded-lg border p-4">
            ...
            >
              <span
                class="pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out"
                :class="
                  notifications.sounds && notificationsEnabled ? 'translate-x-5' : 'translate-x-0'
                "
              />
            </button>
          </div>
