    ...
    <div class="entry-container">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription> Paste the connection URL or your secret key </CardDescription>
        </CardHeader>
        <CardContent>
          <!-- Input State -->
            ...
            <form class="form" @submit.prevent="handleSubmit">
              <div class="input-group">
                <Input
                  ...
                  class="input"
                />
                <Button type="button" variant="outline" size="icon" @click="pasteFromClipboard">
                  <Clipboard class="h-4 w-4" />
                </Button>
              </div>
              <Button type="submit" class="w-full" :disabled="!manualInput.trim()">
                Connect
              </Button>
            </form>
          </template>
      ...
      <!-- Instructions -->
      <div v-if="state === 'input'" class="instructions">
