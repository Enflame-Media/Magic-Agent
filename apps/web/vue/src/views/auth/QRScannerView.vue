...
<template>
  <ResponsiveContainer size="narrow" padding="default" class="scanner-view">
    <div class="scanner-container">
        ...
        <CardContent>
          ...
          <template v-else-if="state === 'connecting'">
            <div class="state-container">
              ...
              <p class="state-description">Establishing connection with the CLI</p>
            </div>
          </template>
          ...
          <template v-else-if="state === 'success'">
            <div class="state-container success">
              ...
              <p class="state-description">You can now see this session in your terminal</p>
            </div>
          </template>
      ...
      <!-- Alternative Option -->
      <div v-if="state === 'scanning'" class="alternative">
        <p>Can't scan the code?</p>
        <Button variant="link" @click="goToManualEntry">
