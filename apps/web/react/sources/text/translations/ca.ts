...
export const ca: TranslationStructure = {
    ...
    settingsAccount: {
        ...
        profileVisibilityPublic: 'Públic',
        profileVisibilityPublicDescription: 'Qualsevol pot veure el teu perfil',
        profileVisibilityFriendsOnly: 'Només amics',
        profileVisibilityFriendsOnlyDescription: 'Només els amics poden veure el teu perfil',
        friendRequestPermission: 'Sol·licituds d\'amistat',
        friendRequestPermissionAnyone: 'Qualsevol',
        friendRequestPermissionAnyoneDescription: 'Qualsevol pot enviar-te sol·licituds d\'amistat',
        friendRequestPermissionFriendsOfFriends: 'Amics d\'amics',
        friendRequestPermissionFriendsOfFriendsDescription: 'Només amics dels teus amics poden enviar sol·licituds',
        friendRequestPermissionNone: 'Ningú',
        friendRequestPermissionNoneDescription: 'Ningú pot enviar-te sol·licituds d\'amistat',
    ...
    acp: {
        ...
        mode: 'Mode',
        content: {
            imageLoadError: 'No s\'ha pogut carregar la imatge',
            audioUnsupported: 'La reproduccio d\'audio no esta suportada',
            unknownType: ({ type }: { type: string }) => `Tipus de contingut no suportat: ${type}`,
            terminal: 'Terminal',
            terminalRef: ({ id }: { id: string }) => `Sessio de terminal: ${id}`,
            terminalCopied: 'Sortida del terminal copiada',
            diffCollapse: 'Mostra menys',
            diffExpand: ({ count }: { count: number }) => `Mostra ${count} linies mes`,
        },
        usage: {
        ...
        commandPalette: {
            title: 'Comandes',
            searchPlaceholder: 'Cercar comandes...',
            emptyTitle: 'Cap comanda disponible',
            emptyDescription: 'Aquest agent no ha registrat cap comanda.',
            noResults: 'Cap comanda coincideix amb la cerca',
            commandCount: ({ count }: { count: number }) => `${count}`,
        },
        config: {
            title: 'Configuració',
            emptyTitle: 'Sense opcions de configuració',
            emptyDescription: 'Aquest agent no ha exposat opcions configurables.',
            applying: 'Aplicant...',
            readOnly: 'Només lectura',
            unknownType: 'Tipus d\'opció no suportat',
            selectPlaceholder: 'Selecciona un valor',
        },
        sessionBrowser: {
            title: 'Sessions',
            emptyTitle: 'Sense sessions',
            emptyDescription: 'No s\'han trobat sessions anteriors per a aquest agent.',
            active: 'Activa',
            load: 'Carregar',
            resume: 'Reprendre',
            fork: 'Bifurcar',
            switchSessionTitle: 'Canviar de sessió?',
            switchSessionMessage: 'Tens una sessió activa. Canviar deixarà la sessió actual.',
            sessionCount: ({ count }: { count: number }) => count === 1 ? '1 sessió' : `${count} sessions`,
        },
        agentPicker: {
            title: 'Agents',
            active: 'Actiu',
            ...
            switchTitle: 'Canviar d\'agent?',
            switchMessage: ({ name }: { name: string }) => `Canviar a ${name}? L'estat de la sessió actual es conservarà.`,
            switchConfirm: 'Canviar',
            switchSuccess: ({ name }: { name: string }) => `Canviat a ${name}`,
            switchFailed: ({ name }: { name: string }) => `Error en canviar a ${name}. S'ha revertit a l'agent anterior.`,
            rollbackNotice: 'El canvi d\'agent ha fallat. S\'ha revertit a l\'agent anterior.',
        },
        permission: {
            title: 'Permis requerit',
            expired: 'Aquesta sol·licitud de permis ha expirat',
            rawInput: 'Mostra entrada sense processar',
            queueCount: ({ count }: { count: number }) => `${count} pendents`,
            notificationTitle: 'Permis sol·licitat',
            notificationBody: ({ tool }: { tool: string }) => `L'agent necessita permis per executar: ${tool}`,
            historyTitle: 'Historial de permisos',
            historyEmpty: 'Sense decisions de permisos encara',
            outcomeSelected: 'Aprovat',
            outcomeExpired: 'Expirat',
            outcomeCancelled: 'Cancel·lat',
        },
    },
    ...
    sharing: {
        ...
        urlSharing: 'Compartir per enllaç',
        enableUrlSharing: 'Habilitar enllaç per compartir',
        enableUrlSharingDescription: 'Qualsevol amb l\'enllaç pot accedir a aquesta sessió',
        permission: 'Permís',
        viewOnly: 'Només veure',
        viewAndChat: 'Veure i xatejar',
        password: 'Contrasenya',
        optionalPassword: 'Contrasenya opcional',
        urlCopied: 'Enllaç copiat al porta-retalls',
        shareMessage: 'Mira aquesta sessió de programació!',
        shareTitle: 'Compartir sessió',
        peopleWithAccess: 'Persones amb accés',
        noShares: 'Ningú més té accés a aquesta sessió',
        addPeople: 'Afegir persones',
        addPeopleDescription: 'Compartir amb amics dels teus contactes',
        selectFriend: 'Selecciona un amic',
        grantPermission: 'Concedir permís',
        searchFriends: 'Cercar amics...',
        noFriendsAvailable: 'No hi ha amics disponibles per compartir',
        noMatchingFriends: 'No s\'han trobat amics coincidents',
        shareAdded: ({ name }: { name: string }) => `Compartit amb ${name}`,
        shareRemoved: 'Accés eliminat',
        removeAccess: 'Eliminar accés',
        removeAccessConfirm: ({ name }: { name: string }) => `Eliminar l'accés de ${name} a aquesta sessió?`,
        remove: 'Eliminar',
        permissionLevel: ({ level }: { level: string }) => `${level}`,
        shareSession: 'Compartir sessió',
        shareSessionSubtitle: 'Compartir aquesta sessió amb amics o per enllaç',
    },
} as const;
