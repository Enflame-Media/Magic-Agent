...
export const pl: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        voiceAssistantDescription: 'Kontroluj dostępność funkcji asystenta głosowego. Po wyłączeniu możliwości interakcji głosowej są niedostępne.',
        enableVoiceAssistant: 'Włącz asystenta głosowego',
        voiceAssistantEnabledSubtitle: 'Funkcje głosowe są aktywne',
        voiceAssistantDisabledSubtitle: 'Funkcje głosowe są wyłączone',
        languageTitle: 'Język',
    ...
    settingsAccount: {
        ...
        profileVisibilityPublic: 'Publiczny',
        profileVisibilityPublicDescription: 'Każdy może zobaczyć Twój profil',
        profileVisibilityFriendsOnly: 'Tylko znajomi',
        profileVisibilityFriendsOnlyDescription: 'Tylko znajomi mogą zobaczyć Twój profil',
        friendRequestPermission: 'Zaproszenia do znajomych',
        friendRequestPermissionAnyone: 'Każdy',
        friendRequestPermissionAnyoneDescription: 'Każdy może wysyłać Ci zaproszenia do znajomych',
        friendRequestPermissionFriendsOfFriends: 'Znajomi znajomych',
        friendRequestPermissionFriendsOfFriendsDescription: 'Tylko znajomi Twoich znajomych mogą wysyłać zaproszenia',
        friendRequestPermissionNone: 'Nikt',
        friendRequestPermissionNoneDescription: 'Nikt nie może wysyłać Ci zaproszeń do znajomych',
        analytics: 'Analityka',
    ...
    acp: {
        ...
        mode: 'Tryb',
        content: {
            imageLoadError: 'Nie udalo sie zaladowac obrazu',
            audioUnsupported: 'Odtwarzanie audio nie jest obslugiwane',
            unknownType: ({ type }: { type: string }) => `Nieobslugiwany typ zawartosci: ${type}`,
            terminal: 'Terminal',
            terminalRef: ({ id }: { id: string }) => `Sesja terminala: ${id}`,
            terminalCopied: 'Skopiowano dane wyjsciowe terminala',
            diffCollapse: 'Pokaz mniej',
            diffExpand: ({ count }: { count: number }) => `Pokaz jeszcze ${count} linii`,
        },
        usage: {
            title: 'Okno kontekstu',
            tokens: ({ used, total }: { used: string; total: string }) => `${used} / ${total} tokenów`,
        },
        commandPalette: {
            title: 'Polecenia',
            searchPlaceholder: 'Szukaj poleceń...',
            emptyTitle: 'Brak dostępnych poleceń',
            emptyDescription: 'Ten agent nie zarejestrował żadnych poleceń.',
            noResults: 'Żadne polecenie nie pasuje do wyszukiwania',
            commandCount: ({ count }: { count: number }) => `${count}`,
        },
        config: {
            title: 'Konfiguracja',
            emptyTitle: 'Brak opcji konfiguracji',
            emptyDescription: 'Ten agent nie udostępnił opcji konfiguracyjnych.',
            applying: 'Stosowanie...',
            readOnly: 'Tylko do odczytu',
            unknownType: 'Nieobsługiwany typ opcji',
            selectPlaceholder: 'Wybierz wartość',
        },
        sessionBrowser: {
            title: 'Sesje',
            emptyTitle: 'Brak sesji',
            emptyDescription: 'Nie znaleziono poprzednich sesji dla tego agenta.',
            active: 'Aktywna',
            load: 'Załaduj',
            resume: 'Wznów',
            fork: 'Rozgałęź',
            switchSessionTitle: 'Zmienić sesję?',
            switchSessionMessage: 'Masz aktywną sesję. Zmiana opuści bieżącą sesję.',
            sessionCount: ({ count }: { count: number }) => count === 1 ? '1 sesja' : `${count} sesji`,
        },
        agentPicker: {
            title: 'Agenci',
            active: 'Aktywny',
            ...
            statusError: 'Błąd',
            agentCount: ({ count }: { count: number }) => count === 1 ? '1 agent' : `${count} agentów`,
            switchTitle: 'Zmienić agenta?',
            switchMessage: ({ name }: { name: string }) => `Przełączyć na ${name}? Stan bieżącej sesji zostanie zachowany.`,
            switchConfirm: 'Przełącz',
            switchSuccess: ({ name }: { name: string }) => `Przełączono na ${name}`,
            switchFailed: ({ name }: { name: string }) => `Nie udało się przełączyć na ${name}. Przywrócono poprzedniego agenta.`,
            rollbackNotice: 'Zmiana agenta nie powiodła się. Przywrócono poprzedniego agenta.',
        },
        permission: {
            title: 'Wymagane uprawnienie',
            expired: 'To żądanie uprawnienia wygasło',
            rawInput: 'Pokaż surowe dane wejściowe',
            queueCount: ({ count }: { count: number }) => `${count} oczekujących`,
            notificationTitle: 'Żądanie uprawnienia',
            notificationBody: ({ tool }: { tool: string }) => `Agent potrzebuje uprawnienia do uruchomienia: ${tool}`,
            historyTitle: 'Historia uprawnień',
            historyEmpty: 'Brak decyzji o uprawnieniach',
            outcomeSelected: 'Zatwierdzono',
            outcomeExpired: 'Wygasło',
            outcomeCancelled: 'Anulowano',
        },
    },

    sharing: {
        // Session sharing UI (HAP-770)
        title: 'Udostępnij sesję',
        urlSharing: 'Udostępnianie linkiem',
        enableUrlSharing: 'Włącz udostępnianie linkiem',
        enableUrlSharingDescription: 'Każdy z linkiem może uzyskać dostęp do tej sesji',
        permission: 'Uprawnienia',
        viewOnly: 'Tylko podgląd',
        viewAndChat: 'Podgląd i czat',
        password: 'Hasło',
        optionalPassword: 'Opcjonalne hasło',
        urlCopied: 'Link skopiowany do schowka',
        shareMessage: 'Sprawdź tę sesję kodowania!',
        shareTitle: 'Udostępnij sesję',
        peopleWithAccess: 'Osoby z dostępem',
        noShares: 'Nikt inny nie ma dostępu do tej sesji',
        addPeople: 'Dodaj osoby',
        addPeopleDescription: 'Udostępnij znajomym z kontaktów',
        selectFriend: 'Wybierz znajomego',
        grantPermission: 'Przyznaj uprawnienia',
        searchFriends: 'Szukaj znajomych...',
        noFriendsAvailable: 'Brak dostępnych znajomych do udostępnienia',
        noMatchingFriends: 'Nie znaleziono pasujących znajomych',
        shareAdded: ({ name }: { name: string }) => `Udostępniono ${name}`,
        shareRemoved: 'Dostęp usunięty',
        removeAccess: 'Usuń dostęp',
        removeAccessConfirm: ({ name }: { name: string }) => `Usunąć dostęp ${name} do tej sesji?`,
        remove: 'Usuń',
        permissionLevel: ({ level }: { level: string }) => `${level}`,
        shareSession: 'Udostępnij sesję',
        shareSessionSubtitle: 'Udostępnij sesję znajomym lub przez link',
    },
} as const;
