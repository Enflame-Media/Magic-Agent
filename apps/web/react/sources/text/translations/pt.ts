...
export const pt: TranslationStructure = {
    ...
    settingsVoice: {
        ...
        voiceAssistantTitle: 'Assistente de voz',
        voiceAssistantDescription: 'Controle se as funcionalidades do assistente de voz estão disponíveis. Quando desativado, as capacidades de interação por voz são desligadas.',
        enableVoiceAssistant: 'Ativar assistente de voz',
        voiceAssistantEnabledSubtitle: 'Funcionalidades de voz estão ativas',
        voiceAssistantDisabledSubtitle: 'Funcionalidades de voz estão desligadas',
    ...
    settingsAccount: {
        ...
        profileVisibilityPublicDescription: 'Qualquer pessoa pode ver seu perfil',
        profileVisibilityFriendsOnly: 'Apenas amigos',
        profileVisibilityFriendsOnlyDescription: 'Apenas amigos podem ver seu perfil',
        friendRequestPermission: 'Pedidos de amizade',
        friendRequestPermissionAnyone: 'Qualquer pessoa',
        friendRequestPermissionAnyoneDescription: 'Qualquer pessoa pode enviar pedidos de amizade',
        friendRequestPermissionFriendsOfFriends: 'Amigos de amigos',
        friendRequestPermissionFriendsOfFriendsDescription: 'Apenas amigos de seus amigos podem enviar pedidos',
        friendRequestPermissionNone: 'Ninguém',
        friendRequestPermissionNoneDescription: 'Ninguém pode enviar pedidos de amizade',
        analytics: 'Análises',
    ...
    machine: {
        ...
        archiveAll: 'Arquivar todas as sessões ativas',
        archiveAllSubtitle: ({ count }: { count: number }) => count === 1 ? 'Arquivar 1 sessão ativa' : `Arquivar ${count} sessões ativas`,
        archiveAllTitle: 'Arquivar todas as sessões ativas?',
        archiveAllMessage: ({ count }: { count: number }) => count === 1 ? 'Isso arquivará 1 sessão ativa. Você poderá restaurá-la mais tarde do arquivo.' : `Isso arquivará ${count} sessões ativas. Você poderá restaurá-las mais tarde do arquivo.`,
        archiveAllSuccess: ({ count }: { count: number }) => count === 1 ? 'Arquivada 1 sessão com sucesso' : `Arquivadas ${count} sessões com sucesso`,
        archiveAllPartial: 'Sucesso parcial',
        archiveAllPartialMessage: ({ successCount, failureCount, failedNames }: { successCount: number; failureCount: number; failedNames: string }) =>
            `Arquivadas com sucesso ${successCount} sessõe${successCount === 1 ? '' : 's'}. Falha ao arquivar ${failureCount} sessõe${failureCount === 1 ? '' : 's'}: ${failedNames}`,
    },
    ...
    acp: {
        ...
        content: {
            ...
            audioUnsupported: 'Reproducao de audio nao suportada',
            unknownType: ({ type }: { type: string }) => `Tipo de conteudo nao suportado: ${type}`,
            terminal: 'Terminal',
            terminalRef: ({ id }: { id: string }) => `Sessao de terminal: ${id}`,
            terminalCopied: 'Saida do terminal copiada',
            diffCollapse: 'Mostrar menos',
            diffExpand: ({ count }: { count: number }) => `Mostrar mais ${count} linhas`,
        },
        usage: {
        ...
        commandPalette: {
            ...
            emptyTitle: 'Nenhum comando disponível',
            emptyDescription: 'Este agente não registrou nenhum comando.',
            noResults: 'Nenhum comando corresponde à pesquisa',
            commandCount: ({ count }: { count: number }) => `${count}`,
        },
        config: {
            title: 'Configuração',
            emptyTitle: 'Sem opções de configuração',
            emptyDescription: 'Este agente não expôs opções configuráveis.',
            applying: 'Aplicando...',
            readOnly: 'Somente leitura',
            unknownType: 'Tipo de opção não suportado',
            selectPlaceholder: 'Selecione um valor',
        },
        sessionBrowser: {
            title: 'Sessões',
            emptyTitle: 'Sem sessões',
            emptyDescription: 'Nenhuma sessão anterior encontrada para este agente.',
            active: 'Ativa',
            load: 'Carregar',
            resume: 'Retomar',
            fork: 'Bifurcar',
            switchSessionTitle: 'Mudar de sessão?',
            switchSessionMessage: 'Você tem uma sessão ativa. Mudar deixará a sessão atual.',
            sessionCount: ({ count }: { count: number }) => count === 1 ? '1 sessão' : `${count} sessões`,
        },
        agentPicker: {
            title: 'Agentes',
            active: 'Ativo',
            ...
            statusError: 'Erro',
            agentCount: ({ count }: { count: number }) => count === 1 ? '1 agente' : `${count} agentes`,
            switchTitle: 'Trocar de agente?',
            switchMessage: ({ name }: { name: string }) => `Trocar para ${name}? O estado da sessão atual será preservado.`,
            switchConfirm: 'Trocar',
            switchSuccess: ({ name }: { name: string }) => `Trocado para ${name}`,
            switchFailed: ({ name }: { name: string }) => `Falha ao trocar para ${name}. Revertido para o agente anterior.`,
            rollbackNotice: 'A troca de agente falhou. Revertido para o agente anterior.',
        },
        permission: {
            title: 'Permissao necessaria',
            expired: 'Esta solicitacao de permissao expirou',
            rawInput: 'Mostrar entrada bruta',
            queueCount: ({ count }: { count: number }) => `${count} pendentes`,
            notificationTitle: 'Permissao solicitada',
            notificationBody: ({ tool }: { tool: string }) => `O agente precisa de permissao para executar: ${tool}`,
            historyTitle: 'Historico de permissoes',
            historyEmpty: 'Sem decisoes de permissoes ainda',
            outcomeSelected: 'Aprovado',
            outcomeExpired: 'Expirado',
    ...
    sharing: {
        ...
        urlSharing: 'Compartilhamento por link',
        enableUrlSharing: 'Habilitar compartilhamento por link',
        enableUrlSharingDescription: 'Qualquer pessoa com o link pode acessar esta sessão',
        permission: 'Permissão',
        viewOnly: 'Apenas visualizar',
        viewAndChat: 'Visualizar e conversar',
        password: 'Senha',
        optionalPassword: 'Senha opcional',
        urlCopied: 'Link copiado para a área de transferência',
        shareMessage: 'Confira esta sessão de programação!',
        shareTitle: 'Compartilhar sessão',
        peopleWithAccess: 'Pessoas com acesso',
        noShares: 'Ninguém mais tem acesso a esta sessão',
        addPeople: 'Adicionar pessoas',
        addPeopleDescription: 'Compartilhar com amigos dos seus contatos',
        selectFriend: 'Selecione um amigo',
        grantPermission: 'Conceder permissão',
        searchFriends: 'Buscar amigos...',
        noFriendsAvailable: 'Não há amigos disponíveis para compartilhar',
        noMatchingFriends: 'Nenhum amigo correspondente encontrado',
        shareAdded: ({ name }: { name: string }) => `Compartilhado com ${name}`,
        shareRemoved: 'Acesso removido',
        removeAccess: 'Remover acesso',
        removeAccessConfirm: ({ name }: { name: string }) => `Remover o acesso de ${name} a esta sessão?`,
        remove: 'Remover',
        permissionLevel: ({ level }: { level: string }) => `${level}`,
        shareSession: 'Compartilhar sessão',
        shareSessionSubtitle: 'Compartilhar esta sessão com amigos ou por link',
    },
} as const;
