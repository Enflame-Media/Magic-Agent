...
export const ru: TranslationStructure = {
    ...
    acp: {
        ...
        content: {
            ...
            audioUnsupported: 'Воспроизведение аудио не поддерживается',
            unknownType: ({ type }: { type: string }) => `Неподдерживаемый тип контента: ${type}`,
            terminal: 'Терминал',
            terminalRef: ({ id }: { id: string }) => `Сессия терминала: ${id}`,
            terminalCopied: 'Вывод терминала скопирован',
            diffCollapse: 'Показать меньше',
            diffExpand: ({ count }: { count: number }) => `Показать ещё ${count} строк`,
        },
        usage: {
            title: 'Окно контекста',
            tokens: ({ used, total }: { used: string; total: string }) => `${used} / ${total} токенов`,
        },
        commandPalette: {
            title: 'Команды',
            searchPlaceholder: 'Поиск команд...',
            emptyTitle: 'Команды недоступны',
            emptyDescription: 'Этот агент не зарегистрировал команд.',
            noResults: 'Ни одна команда не соответствует запросу',
            commandCount: ({ count }: { count: number }) => `${count}`,
        },
        config: {
            title: 'Конфигурация',
            emptyTitle: 'Нет параметров конфигурации',
            emptyDescription: 'Этот агент не предоставил настраиваемых параметров.',
            applying: 'Применение...',
            readOnly: 'Только чтение',
            unknownType: 'Неподдерживаемый тип параметра',
            selectPlaceholder: 'Выберите значение',
        },
        sessionBrowser: {
            title: 'Сессии',
            emptyTitle: 'Нет сессий',
            emptyDescription: 'Предыдущие сессии для этого агента не найдены.',
            active: 'Активна',
            load: 'Загрузить',
            resume: 'Возобновить',
            fork: 'Ответвить',
            switchSessionTitle: 'Сменить сессию?',
            switchSessionMessage: 'У вас есть активная сессия. Переключение покинет текущую сессию.',
            sessionCount: ({ count }: { count: number }) => count === 1 ? '1 сессия' : `${count} сессий`,
        },
        agentPicker: {
            title: 'Агенты',
            active: 'Активен',
            ...
            statusError: 'Ошибка',
            agentCount: ({ count }: { count: number }) => count === 1 ? '1 агент' : `${count} агентов`,
            switchTitle: 'Сменить агента?',
            switchMessage: ({ name }: { name: string }) => `Переключиться на ${name}? Состояние текущей сессии будет сохранено.`,
            switchConfirm: 'Переключить',
            switchSuccess: ({ name }: { name: string }) => `Переключено на ${name}`,
            switchFailed: ({ name }: { name: string }) => `Не удалось переключиться на ${name}. Выполнен откат к предыдущему агенту.`,
            rollbackNotice: 'Смена агента не удалась. Выполнен откат к предыдущему агенту.',
        },
        permission: {
            title: 'Требуется разрешение',
            expired: 'Этот запрос на разрешение истёк',
            rawInput: 'Показать необработанный ввод',
            queueCount: ({ count }: { count: number }) => `${count} в ожидании`,
            notificationTitle: 'Запрошено разрешение',
            notificationBody: ({ tool }: { tool: string }) => `Агент запрашивает разрешение на выполнение: ${tool}`,
            historyTitle: 'История разрешений',
            historyEmpty: 'Решений по разрешениям пока нет',
            outcomeSelected: 'Одобрено',
            outcomeExpired: 'Истекло',
    ...
    sharing: {
        ...
        urlSharing: 'Доступ по ссылке',
        enableUrlSharing: 'Включить доступ по ссылке',
        enableUrlSharingDescription: 'Любой, у кого есть ссылка, может получить доступ к этой сессии',
        permission: 'Разрешение',
        viewOnly: 'Только просмотр',
        viewAndChat: 'Просмотр и чат',
        password: 'Пароль',
        optionalPassword: 'Необязательный пароль',
        urlCopied: 'Ссылка скопирована в буфер обмена',
        shareMessage: 'Посмотрите эту сессию кодирования!',
        shareTitle: 'Поделиться сессией',
        peopleWithAccess: 'Люди с доступом',
        noShares: 'Никто больше не имеет доступа к этой сессии',
        addPeople: 'Добавить людей',
        addPeopleDescription: 'Поделиться с друзьями из ваших контактов',
        selectFriend: 'Выберите друга',
        grantPermission: 'Предоставить разрешение',
        searchFriends: 'Поиск друзей...',
        noFriendsAvailable: 'Нет друзей для добавления',
        noMatchingFriends: 'Подходящие друзья не найдены',
        shareAdded: ({ name }: { name: string }) => `Доступ предоставлен ${name}`,
        shareRemoved: 'Доступ удалён',
        removeAccess: 'Удалить доступ',
        removeAccessConfirm: ({ name }: { name: string }) => `Удалить доступ ${name} к этой сессии?`,
        remove: 'Удалить',
        permissionLevel: ({ level }: { level: string }) => `${level}`,
        shareSession: 'Поделиться сессией',
        shareSessionSubtitle: 'Поделиться сессией с друзьями или по ссылке',
    },
} as const;
