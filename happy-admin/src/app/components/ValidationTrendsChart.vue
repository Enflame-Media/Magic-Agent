...
/**
 * ValidationTrendsChart Component
 *
 * Line chart displaying validation failures over time.
 * Multi-series: Total, Unknown Types, Schema, Strict
...
<template>
    <div class="card">
        ...
        <div v-else-if="!hasData" class="h-64 flex items-center justify-center">
            <p class="text-gray-400 dark:text-gray-500">No validation data available</p>
        </div>
